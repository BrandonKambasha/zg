...
function BuildHamperContent() {
  ...
  useEffect(() => {
    // Check if user is authenticated for both creating and editing hampers
    if (!authLoading && !isAuthenticated) {
      toast.error("Please log in to create or edit hampers")
      const redirectPath = editHamperId
        ? `/login?redirect=/hampers/build?edit=${editHamperId}`
        : "/login?redirect=/hampers/build"
  ...
  const loadHamperForEditing = async (hamperId: string) => {
    ...
    try {
      ...
      if (hamper.products && hamper.products.length > 0) {
        ...
        // If more than 3 products, automatically expand the list
  ...
  // Display only the first 3 products when collapsed
  const visibleProducts = showAllProducts ? selectedProducts : selectedProducts.slice(0, 3)
  const hiddenProductsCount = selectedProducts.length - 3
    ...
    return (
      <div className="min-h-[60vh] flex justify-center items-center">
        <div className="text-center max-w-md mx-auto p-6 bg-white rounded-lg shadow-sm border border-gray-200">
          <LogIn className="h-12 w-12 text-teal-600 mx-auto mb-4" />
          <h2 className="text-xl font-bold text-gray-900 mb-2">Authentication Required</h2>
          <p className="text-gray-600 mb-6">
            You need to be logged in to create or edit hampers. Please log in to continue.
          </p>
          <Link
          ...
          <div className="mt-4">
            <Link href="/hampers" className="text-teal-600 hover:text-teal-700 text-sm">
              ← Back to Hampers
            </Link>
          </div>
        </div>
  ...
  return (
    <div className="container mx-auto px-4 py-6 md:py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* Hamper Summary - Fixed layout with scrollable product list */}
        <div className="lg:col-span-1 order-1 lg:order-2" ref={productListRef}>
          <div className="bg-white border border-gray-200 rounded-lg shadow-sm sticky top-4">
            ...
            <div className="p-4 border-b border-gray-100">
              <h2 className="text-lg font-semibold">{isEditMode ? "Edit Your Custom Hamper" : "Your Custom Hamper"}</h2>
            </div>
            ...
            <div className="p-4 max-h-[calc(100vh-350px)] overflow-y-auto">
              ...
              <div className="mb-4">
                ...
                {hamperImagePreview ? (
                  <div className="relative">
                    ...
                    <div className="absolute top-0 right-0 flex space-x-1">
                      <button
                        ...
                        className="p-1 bg-white/80 backdrop-blur-sm rounded-full shadow-sm hover:bg-white transition-colors"
                        title="Remove image"
                      >
                  ...
                  <button
                    ...
                    className="flex items-center justify-center w-full px-3 py-2 border border-gray-300 border-dashed rounded-md hover:bg-gray-50 transition-colors"
                  >
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <h3 className="font-medium text-sm text-gray-600">Selected Products</h3>
                ...
                {selectedProducts.length === 0 ? (
                  <div className="text-center py-3 border border-dashed border-gray-200 rounded-md">
                    <p className="text-gray-500 text-xs">Add products to your hamper</p>
                  </div>
                ) : (
                  <div>
                    ...
                    {/* Show more/less products toggle */}
                    {selectedProducts.length > 3 && (
                      <button
                        onClick={() => setShowAllProducts(!showAllProducts)}
                        className="w-full text-xs flex items-center justify-center py-1.5 text-teal-600 hover:bg-teal-50 rounded-md transition-colors"
                      >
                        {showAllProducts ? (
                          <>
                          ...
                          <>
                            ...
                            Show {hiddenProductsCount} More Item{hiddenProductsCount !== 1 ? "s" : ""}
                          </>
                        )}
                      </button>
                    )}
            ...
            <div className="p-4 border-t border-gray-200">
              ...
              <div className="space-y-2">
                ...
                >
                  {isSaving ? (
                    ...
                    <>
                      ...
                      {isEditMode ? "Update Hamper" : "Save Hamper"}
                    </>
                  )}
                </button>
                ...
                <button
                  ...
                  disabled={selectedProducts.length === 0 || isSaving}
                  className={`w-full py-2 rounded-md font-medium flex items-center justify-center border ${
                    selectedProducts.length === 0 || isSaving
                ...
                <Link
                  href="/hampers/my-hampers"
                  className="w-full py-2 rounded-md font-medium flex items-center justify-center border border-gray-300 text-gray-600 hover:bg-gray-50"
                >
